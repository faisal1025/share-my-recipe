...
public class RecipeWithoutChefDto {
    ...
    public RecipeWithoutChefDto() {
    }

    public RecipeWithoutChefDto(Long recipeId, String title, String summary, List<String> steps, List<Ingredient> ingredients, String featuredImageUrl, List<String> imageUrls) {
    ...
    public RecipeWithoutChefDto(Recipe recipe) {
